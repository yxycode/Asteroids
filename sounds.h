...
struct SoundData
{
    static const int MAX_WAVEHDR_COPIES = 10;
    ...
    WAVEHDR wh;
    HWAVEOUT hWaveOut;
    WAVEHDR whlist[MAX_WAVEHDR_COPIES];
};
//~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~* 
...
{
    for( i = 0; i < SoundData::MAX_WAVEHDR_COPIES; i++ )
        SoundDataList[i].whlist[i] = SoundDataList[i].wh;
    return 1;
}
else
{
...
{
   int k = rand() % SoundData::MAX_WAVEHDR_COPIES;
   
   waveOutWrite(SoundDataList[index].hWaveOut,&SoundDataList[index].whlist[k],sizeof(SoundDataList[index].wh)); 
}
//~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*~*
~SoundBox()
{
